...
export const animate = (camera, cameraMesh, setCamPosition, setCamRotation, setStartRotate, initialPos) => {
  return new Promise((resolve, reject) => {
    ...
    gsap.to(cameraMesh.position, { ease: "easeInOutCubic", duration: (animDuration - 1), delay: 1, x: -57.53, z: -8, 
      onUpdate: () => {
        // setStartRotate(true);
        // let cameraClone = camera.clone();
        // cameraClone.lookAt(cameraMesh.position);
      ...
      gsap.to(camera, { ease: "easeInOutCubic", duration: animDuration, zoom: 6.5 })
