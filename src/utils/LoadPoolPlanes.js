...
const planes = [
  {
    width: 21,
    height: 10,
    position: new Vector3(31.383106006630963, 2.774262009854787, 21.67757484053361),
    rotation: new Euler(0, Math.PI / 2, 0)
  },
  {
    width: 21,
    height: 10,
    position: new Vector3(45.30969219965357, 2.774262009854787, 21.67757484053361),
    rotation: new Euler(0, Math.PI / 2, 0)
  },
  {
    width: 5,
  ...
  },
  {
    width: 5,
    height: 10,
    position: new Vector3(42.876029369005444, 2.774262009854787, 11.121703756194407),
    rotation: new Euler(0, 0, 0)
  },
  {
    width: 10.5,
    height: 10,
    position: new Vector3(36.17056805662442, 2.774262009854787, 26.080025937231436),
    rotation: new Euler(0, Math.PI / 2, 0)
  },
  {
    width: 10.5,
    height: 10,
    position: new Vector3(40.6027439915502, 2.774262009854787, 16.20403915829007),
    rotation: new Euler(0, Math.PI / 2, 0)
  },
  {
    width: 11.5,
    height: 10,
    position: new Vector3(38.378995136740524, 2.774262009854787, 16.404942252292891),
    rotation: new Euler(0, - Math.PI / 2.68, 0)
  },
  {
    width: 11.5,
    height: 10,
    position: new Vector3(38.38640489255621, 2.774262009854787, 25.77485664925358),
    rotation: new Euler(0, - Math.PI / 2.68, 0)
  },
]
...
export const loadPlanes = (scene, world) => {
  planes.forEach((plane) => {
    let planeBody = new CANNON.Body({
      mass: 0,
      shape: new CANNON.Box(new CANNON.Vec3(plane.width, plane.height, 0.1)),
    ...
    let geometry = new BoxGeometry(plane.width, plane.height, 0.1);
